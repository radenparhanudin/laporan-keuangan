...
<html>
    <head>
        ...
        <title>Laporan Keuangan | Log in</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="{{ url('/login') }}"><b>Laporan</b> KEUANGAN</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" name="email" value="{{ old('email') }}" class="form-control" placeholder="Email or Username">
                    ...
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-xs-8">
                            <a href="{{ url('/') }}" class="btn btn-danger flat">Kembali Ke Halaman Depan</a>
                        </div>
                        <div class="col-xs-4">
