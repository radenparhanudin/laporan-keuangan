        ...
        <div class="col-sm-12">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h1 class="box-title">Data Lainnya</span></h1>
                    <div class="pull-right">
                        <a href="{{ route('laporan_lainnya.create') }}" class="btn btn-warning flat"><i class="fa fa-plus"></i><span class="backto"> Tambah Lainnya</span></a>
                        <a href="{{ route('cetaklainnya.index') }}" target="_blank" class="btn btn-danger flat"><i class="fa fa-print"></i> Laporan Lainnya</a>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    <table id="tabel" class="table table-bordered table-striped nowrap" style="width: 100%">
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="5" style="text-align:right">Total Lainnya : </th>
                                <th></th>
                                <th colspan="2"></th>
                            </tr>
                        </tfoot>
    ...
    <script>
        $(document).ready(function() {
            table = $('#tabel').DataTable({
                ...
                // "order": [[ 4, "desc" ]],
                columns: [
                    { data: 'tanggal_lainnya', name: 'tanggal_lainnya' },
                    { data: 'nomor_lainnya', name: 'nomor_lainnya' },
