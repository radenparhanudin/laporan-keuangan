...
<html>
    ...
    <body>
        <table id="tabel" class="table table-bordered table-striped nowrap" style="width: 100%">
            <caption><h1 class="text-center">Laporan Klise</h1></caption>
            <thead>
                <tr>
                    <th  style="vertical-align: middle; text-align: center;">No</th>
                    <th  style="vertical-align: middle; text-align: center;">Tanggal Klise</th>
            ...
            <tbody>
                @php
                    $no = 1;
                @endphp
                @foreach ($klise as $field)
                    <tr>
                        <td class="text-center">{{ $no++ }}</td>
                        <td >{{ $field->tanggal_klise }}</td>
                        <td class="text-center">{{ $field->nomor_klise }}</td>
