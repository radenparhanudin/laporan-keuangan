        ...
        <table id="tabel" class="table table-bordered table-striped nowrap" style="width: 100%">
            ...
            <thead>
                <tr>
                    ...
                    <th  style="vertical-align: middle; text-align: center;">Penjelasan</th>
            ...
            <tbody>
                ...
                @foreach ($jasa as $field)
                    <tr>
                        ...
                        <td class="text-right">{{ $field->keterangan }}</td>
                        <td class="text-right">{{ $field->penjelasan }}</td>
                        <td class="text-right">{{ number_format($field->jumlah, 2, ',', '.') }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
